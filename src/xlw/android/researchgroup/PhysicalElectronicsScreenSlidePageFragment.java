 ...
 */
public class PhysicalElectronicsScreenSlidePageFragment extends Fragment {
    /**
     ...
     */
    public static PhysicalElectronicsScreenSlidePageFragment create(int pageNumber) {
    	PhysicalElectronicsScreenSlidePageFragment fragment = new PhysicalElectronicsScreenSlidePageFragment();
    ...
    public PhysicalElectronicsScreenSlidePageFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        */
        if(mPageNumber==0)
        {
        	final String name_str="Jelena Vuckovic\n";
        	...
        	final String interest_str="Research areas: nanophotonics, quantum optics, nonlinear optics, quantum information technologies, optoelectronics, cavity QED\n";
        ...
        ClickableSpan department_clickableSpan = new ClickableSpan() {
            ...
            public void onClick(View textView) {
            	...
            	myIntent.putExtra("ResearchArea",4);
        ...
        button_delete.setOnClickListener(new OnClickListener()
        {
        	  ...
        	  public void onClick(View v)
        	  {
        	    ...
        	    //Log.v(TAG, "DELETE");
        	    cursor=MainActivity.datasource.queryfromFavorite_ResearchArea_PageNumber(4,0);
        	    cursor.moveToFirst();
        ...
        {
        	final String name_str="Jeffrey Bokor\n";
        	final String position_str="Professor, Associate Dean\n";
        	...
        	final String interest_str="His current research activities include novel techniques for nanofabrication, new devices for nanoelectronics, quantum information processing, extreme ultraviolet lithography, optical metrology, and Fourier optics.\n";
        ...
        button_delete.setOnClickListener(new OnClickListener()
        {
        	  ...
        	  public void onClick(View v)
        	  {
        		...
        		System.out.println("DELETE");
        	    //Log.v(TAG, "DELETE");
        	    cursor=MainActivity.datasource.queryfromFavorite_ResearchArea_PageNumber(4,1);
        	    cursor.moveToFirst();
        	    Favorite favorite = MainActivity.datasource.cursorToFavorite(cursor);
        	    MainActivity.datasource.deleteFavorite(favorite);
        	    cursor.close();
        ...
        {
        	final String name_str="Rajeev Ram\n";
        	final String position_str="Professor\n";
        	final String department_str="Department of Electrical Engineering\n";
        	final String university_str="Massachusetts Institute of Technology\n";
        	final String interest_str=" His research focuses on the development of novel photonics & electronics for communications, energy, and sensing.\n";
        ...
        button_delete.setOnClickListener(new OnClickListener()
        {
        	  ...
        	  public void onClick(View v)
        	  {
        		...
        		System.out.println("DELETE");
        	    //Log.v(TAG, "DELETE");
        	    cursor=MainActivity.datasource.queryfromFavorite_ResearchArea_PageNumber(4,2);
        	    cursor.moveToFirst();
        	    Favorite favorite = MainActivity.datasource.cursorToFavorite(cursor);
        	    MainActivity.datasource.deleteFavorite(favorite);
        	    cursor.close();
